...
export default function Index() {
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        "Essential security practices for production Kubernetes clusters, including RBAC, network policies, and secrets management.",
    ...
    },
    {
      ...
      excerpt:
        "Optimize your CI/CD workflows with parallel execution, matrix builds, and intelligent test distribution.",
      readTime: "9 min read",
      date: "Oct 28, 2024",
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {technologies.map((tech) => {
              ...
              return (
                <Card
                  key={tech.name}
                  className="border-2 hover:shadow-lg transition-all duration-300 hover:border-slate-300"
                >
                  <CardHeader className="text-center">
                    <div
                      className={`w-12 h-12 mx-auto mb-4 rounded-lg bg-slate-100 flex items-center justify-center ${tech.color}`}
                    >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {recentPosts.map((post) => (
              <Card
                key={post.id}
                className="group hover:shadow-lg transition-all duration-300 cursor-pointer hover:border-slate-300"
              >
                <CardHeader>
